...
<title>${lowerEntityDomain}管理</title>
...
<script src="/js/model/${lowerEntityDomain}.js"></script>
</head>
<body>
	<s:fielderror />
	<div class="main-content">
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					<a href="/${lowerEntityDomain}.action">${lowerEntityDomain}列表</a> <small> <i
						class="icon-double-angle-right"></i> <s:if test="id==null">
							新增${lowerEntityDomain}信息
						</s:if> <s:else>
							${lowerEntityDomain}编辑修改
						</s:else>
					</small>
				</h1>
			</div>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<s:form id="${lowerEntityDomain}Form" action="${lowerEntityDomain}_save"
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								<button class="btn btn-info" type="button"
									onClick="location.href='/${lowerEntityDomain}.action'">
