	...
	<s:form action="permission" id="domainForm">
		<div class="main-content">
			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						<h4 class="header smaller lighter blue">Permission列表</h4>
						<!-- 高级查询 begin -->
						名称：
						<s:textfield name="baseQuery.name" placeholder="输入名称" />
						方法:
						<s:textfield name="baseQuery.method" placeholder="输入方法" />
						...
						<span style="text-align: right; display: block;"> <a
							class="green" href="/permission_input.action"> <i
									...
									<s:iterator value="pageList.data">
										...
										<td>
											<div
												...
												</a> <a class="green" href="#" onclick="updateDomain('permission',${id});"> <i
													class="icon-pencil bigger-130"></i>
												</a> <a class="red" href="#" onclick="deleteDomain('/permission_delete.action?id=${id}',this);">
