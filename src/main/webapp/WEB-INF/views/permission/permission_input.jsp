	...
	<div class="main-content">
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					<a href="/permission.action">permission列表</a> <small> <i
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<s:form id="permissionForm" action="permission_save"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<s:textarea name="desc" placeholder="备注"  cols="15" rows="8"
									class="col-xs-10 col-sm-5" id="form-field-1" />
							</div>
						</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								<button class="btn btn-info" type="button"
									onClick="location.href='/permission.action'">
