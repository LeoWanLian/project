	...
	<s:form action="systemDictionaryDetail" id="domainForm">
		<div class="main-content">
			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						<h4 class="header smaller lighter blue">SystemDictionaryDetail列表</h4>
						<!-- 高级查询 begin -->
						名称：
						...
						<span style="text-align: right; display: block;"> <a
							class="green" href="/systemDictionaryDetail_input.action"> <i
									...
									<s:iterator value="pageList.data">
										...
										<td>
											<div
												...
												</a> <a class="green" href="#" onclick="updateDomain('systemDictionaryDetail',${id});"> <i
													class="icon-pencil bigger-130"></i>
												</a> <a class="red" href="#" onclick="deleteDomain('/systemDictionaryDetail_delete.action?id=${id}',this);">
