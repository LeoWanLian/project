	...
	<div class="main-content">
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					<a href="/role.action">role列表</a> <small> <i
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<s:form id="roleForm" action="role_save"
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
								for="form-field-1"> 当前角色拥有的权限  </label>
								
							<div class="col-sm-9">
								<s:checkboxlist list="#allPermissions" name="ids" listKey="id"
								listValue="name" id="form-field-5"></s:checkboxlist>
							</div>
						</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								<button class="btn btn-info" type="button"
									onClick="location.href='/role.action'">
