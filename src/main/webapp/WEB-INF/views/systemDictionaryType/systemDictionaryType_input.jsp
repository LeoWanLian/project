	...
	<div class="main-content">
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					<a href="/systemDictionaryType.action">systemDictionaryType列表</a> <small> <i
						class="icon-double-angle-right"></i> <s:if test="id==null">
							新增systemDictionaryType信息
						</s:if> <s:else>
							systemDictionaryType编辑修改
						</s:else>
					</small>
				</h1>
			</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								<button class="btn btn-info" type="button"
									onClick="location.href='/systemDictionaryType.action'">
