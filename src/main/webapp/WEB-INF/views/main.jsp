				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="${userInSession.headImage}" alt="Jason's Photo" /> <span
						...
						<ul
							...
							<li><a href="#" data-toggle="modal" data-target="#pwdModal"> <i
									class="icon-user"></i> 个人资料
							</a></li>

							<li class="divider"></li>

							<li><a href="login_logout.action"> <i class="icon-off"></i>
									退出
							</a></li>
						</ul></li>
				</ul>
		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active"><a href="/main.action"> <i
							class="icon-dashboard"></i> <span class="menu-text"> 控制台 </span>
					</a></li>
					<s:iterator value="#menus">
						<li><a href="#" class="dropdown-toggle"> <i class=${icon}></i>
								<span class="menu-text"> ${name} </span> <b
								class="arrow icon-angle-down"></b>
						</a>
							<ul class="submenu">
								<s:iterator value="children">
									<li><a href="${url}" target="main"> <i class=${icon}></i>
											${name}
									</a></li>
								</s:iterator>
							</ul></li>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					旧密码:<input type="password" name="oldPwd" id="oldpwd"><br />
					<br /> 新密码:<input type="textfild" name="newPwd" id="newpwd1"><br />
					<br /> 确认新密码:<input type="textfild" name="newPwd" id="newpwd2"><br />
					<br />
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭
					</button>
					<button type="button" class="btn btn-primary" onclick="changePwd('main');">提交更改</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
