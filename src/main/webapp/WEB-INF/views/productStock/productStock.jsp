...
<title>ProductStock管理</title>
</head>
<body>
	<s:fielderror />
	<s:form action="productStock" id="domainForm">
		<div class="main-content">
			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						<h4 class="header smaller lighter blue">ProductStock列表</h4>
						<!-- 高级查询 begin -->
						名称：
						...
						<span style="text-align: right; display: block;"> <a
							class="green" href="/productStock_input.action"> <i
									...
									<s:iterator value="pageList.data">
										...
										<td>
											<div
												...
												</a> <a class="green" href="#" onclick="updateDomain('productStock',${id});"> <i
													class="icon-pencil bigger-130"></i>
												</a> <a class="red" href="#" onclick="deleteDomain('/productStock_delete.action?id=${id}',this);">
